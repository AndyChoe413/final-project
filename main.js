...
document.querySelector('#carousel-button-info').addEventListener('click', () => {
   ...
   if (slidePosition === 0) {
      ...
      info.textContent = `British guitarist and singer-songwriter Eric Clapton has released 24 studio albums, 26 singles, 18 compilations, 15 live albums and six soundtrack albums as a solo artist and scores of collaborations on records with other artists.
